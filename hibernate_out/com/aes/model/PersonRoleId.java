...
public class PersonRoleId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PersonRoleId) ) return false;
		 PersonRoleId castOther = ( PersonRoleId ) other; 
         
		 return ( (this.getPersonroleId()==castOther.getPersonroleId()) || ( this.getPersonroleId()!=null && castOther.getPersonroleId()!=null && this.getPersonroleId().equals(castOther.getPersonroleId()) ) )
