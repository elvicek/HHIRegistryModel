...
public class SurveyReadings  implements java.io.Serializable {
    ...
    public SurveyReadings(int readingId, int surveyId, String location, String readingType, String unit, String value, String description, String createdBy, Date createdDate) {
       this.readingId = readingId;
       this.surveyId = surveyId;
