...
public class AddressHome {
	...
	public Address findById(int id) {
		...
		try {
			Address instance = (Address) sessionFactory.getCurrentSession().get("com.aes.data.dao.Address", id);
			if (instance == null) {
	...
	public List<Address> findByExample(Address instance) {
		...
		try {
			List<Address> results = (List<Address>) sessionFactory.getCurrentSession()
					.createCriteria("com.aes.data.dao.Address").add(create(instance)).list();
