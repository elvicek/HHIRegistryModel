...
public class PersonHome {
	...
	public Person findById(int id) {
		...
		try {
			Person instance = (Person) sessionFactory.getCurrentSession().get("com.aes.data.dao.Person", id);
			if (instance == null) {
	...
	public List<Person> findByExample(Person instance) {
		...
		try {
			List<Person> results = (List<Person>) sessionFactory.getCurrentSession()
					.createCriteria("com.aes.data.dao.Person").add(create(instance)).list();
