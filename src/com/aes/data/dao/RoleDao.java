...
public class RoleDao {
	...
	public Role findById(java.lang.String id) {
		...
		try {
			Role instance = (Role) sessionFactory.getCurrentSession().get("com.aes.data.dao.Role", id);
			if (instance == null) {
	...
	public List<Role> findByExample(Role instance) {
		...
		try {
			List<Role> results = (List<Role>) sessionFactory.getCurrentSession().createCriteria("com.aes.data.dao.Role")
